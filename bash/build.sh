...
cd dist
echo -e "\n## Summary statistics of each dataset:" >> index.md
ls *stat* | awk -F "." 'BEGIN{OFS=""} {print "- [",toupper(substr($1,1,1)),substr($1,2),"](https://hubmapconsortium.github.io/asctb-azimuth-data-comparison/",$1,".",$2,".csv)"}' >> index.md